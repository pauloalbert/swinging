 ...
 */
MAC_EXTERN inline int* get_buffer_pointer(enum BUFFER_TYPE bT);
MAC_EXTERN inline int get_buffer_width(enum BUFFER_TYPE bT);
MAC_EXTERN inline int get_buffer_height(enum BUFFER_TYPE bT);
/*
